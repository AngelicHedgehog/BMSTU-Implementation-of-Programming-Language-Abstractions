...
:_true_while_0_gcd 
GETFP 5 SUB GETFP LOAD 2 ADD LOAD GETFP LOAD 2 ADD GETFP LOAD 3 ADD LOAD SAVE GETFP LOAD 3 ADD LOAD MOD SAVE 
GETFP LOAD 3 ADD GETFP 5 SUB LOAD SAVE 
_loop_while_0_gcd JMP 
:_exit_while_0_gcd 
GETFP SETSP SETFP 
GETFP 2 SUB GETFP 2 ADD LOAD SAVE 
GETFP 2 SUB LOAD _printInt CALL GETRV DROP 
GETFP 2 SUB LOAD SETRV __gcd JMP 
:__gcd 
GETFP SETSP SETFP 
2 RETN 
