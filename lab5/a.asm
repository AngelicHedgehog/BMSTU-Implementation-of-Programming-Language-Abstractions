...
GETFP 3 SUB LOAD 4 ADD 1 SAVE 
GETFP GETSP SETFP 
1 PUSHN 
GETFP 1 SUB GETFP LOAD 3 SUB LOAD 5 ADD SAVE 
GETFP 1 SUB LOAD SETRV GETFP SETSP SETFP 
GETRV SETRV __allocBlock__ JMP 
GETFP GETSP SETFP 
1 PUSHN 
...
:_DynVarBase____delete 
GETFP GETSP SETFP 
:__DynVarBase____delete 
GETFP SETSP SETFP 
1 RETN 

:_DynVarBase___vtbl__ 
0 _DynVarBase____delete 
...
GETFP 1 SUB GETFP LOAD 2 ADD LOAD 1 ADD LOAD SAVE 
GETFP 1 SUB LOAD SETRV GETFP SETSP SETFP 
GETRV SETRV __Animal__getName JMP 
:__Animal__getName 
GETFP SETSP SETFP 
1 RETN 
...
GETFP 1 SUB 1 SAVE 
GETFP 1 SUB LOAD SETRV GETFP SETSP SETFP 
GETRV SETRV __Animal__getType JMP 
:__Animal__getType 
GETFP SETSP SETFP 
1 RETN 
